...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void testUniqueMailCreate() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(post(REST_URL + "/register").contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(createdTo)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
    ...
    void testUniqueMailUpdate() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(put(REST_URL).contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(USER))
                .content(JsonUtil.writeValue(updatedTo)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity());
