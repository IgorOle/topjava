...
<section>
    ...
    <input type="hidden" id="filtered" value="0">
    ...
    <table border="1" cellpadding="8" cellspacing="0" id="datatable">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}" >
                ...
                <td><a onclick="deleteRow(${meal.id})"><span class="fa fa-remove"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><a><spring:message code="meal.add"/></a></h4>
